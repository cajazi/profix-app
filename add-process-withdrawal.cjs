...
// Find showWithdrawalRequest function and add processWithdrawal before it
const processWithdrawalFn = `
async function processWithdrawal(user, bankName, accountNumber, accountName, amount, balance) {
...
code = code.replace(
  "function showWithdrawalRequest(user, balance) {",
  processWithdrawalFn + "\nfunction showWithdrawalRequest(user, balance) {"
)

fs.writeFileSync("src/main.js", code, "utf8")
console.log("processWithdrawal function added")
